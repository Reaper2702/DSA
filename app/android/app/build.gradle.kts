...
// version control. Without it the release build falls back to the debug key so
// `flutter run --release` still works locally — but a debug-signed build is
...
android {
    ...
    defaultConfig {
        // Must stay stable once the app is published: it is the app's identity
        // in the Play Store and cannot be changed afterwards.
        applicationId = "com.trumpcards.trump_cards"
